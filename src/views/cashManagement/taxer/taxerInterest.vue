    ...
    <div class="plr30">
        <div>
            ...
            <el-table border class="mtb20" :data="otherTransList">
                ...
                <el-table-column min-width='85px' prop="结息日期" label="结息日期"></el-table-column>
                <el-table-column min-width='85px' prop="分配状态" label="分配状态"></el-table-column>
                <el-table-column min-width='85px' prop="收支方向" label="收支方向"></el-table-column>
                <el-table-column min-width='85px' prop="交易币种" label="交易币种"></el-table-column>
                <el-table-column min-width='90px' prop="利息" label="利息"></el-table-column>
                <el-table-column min-width='85px' prop="对方账号" label="对方账号"></el-table-column>
                <el-table-column min-width='85px' prop="对方户名" label="对方户名"></el-table-column>
                <el-table-column min-width='85px' prop="起息日" label="起息日"></el-table-column>
                <el-table-column min-width='85px' prop="止息日" label="止息日"></el-table-column>
                <el-table-column prop="postscript" label="操作" >
                    <template slot-scope="scope">
                        <a @click="goInterest(scope)">分配</a>
                    </template>
                </el-table-column>
            </el-table>
            <el-pagination
...
<script>
    export default {
        ...
        methods: {
            ...
            goInterest(scope) {
                let value = scope.row;
                // sessionStorage.setItem('taxerInterestPro', JSON.stringify(value));
                this.$router.push('/cashManagement/taxerInterestPro')
            },
        }
    }
</script>