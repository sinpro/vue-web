<template>
    <div class="plr30">
            ...
            <div>
                <el-form ref="formData" :model="formData" :rules="formRules" label-width="150px">
                    <el-row :gutter="24">
                        ...
                        <el-col :span="15">
                            <el-form-item label="交易状态:" prop="交易类型">
        ...
        <el-table border class="mtb20" :data="otherTransList">
            ...
            <el-table-column min-width='120px' prop="交易状态" label="交易状态"></el-table-column>
            <el-table-column min-width='120px' prop="处理信息" label="处理信息"></el-table-column>
            ...
            <el-table-column min-width='120px' prop="对方所属银行" label="对方所属银行"></el-table-column>
            ...
            <el-dialog :visible.sync="detailInfo" :close-on-click-modal='false' :close-on-press-escape='false'>
                ...
                <table class='wr100' cellspacing="0" border="1">
                    ...
                    <tr class="h40 ">
                        ...
                        <td class="pl10"></td>
                        <td class="pl10" colspan="2">交易状态</td>
                        <td class="pl10"></td>
                    </tr>
                    <tr class="h40 ">
