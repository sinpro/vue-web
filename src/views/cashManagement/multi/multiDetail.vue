    ...
    <div class="plr30">
        ...
        <el-pagination
            ...
            <el-dialog :visible.sync="detailInfo" :close-on-click-modal='false' :close-on-press-escape='false'>
                <div slot="title" class="tl f18 bold">多级账簿明细详情</div>
...
<script>
    export default {
        ...
        methods: {
            ...
            goMoney(scope){
                let value = scope.row
                sessionStorage.setItem('valMoney', JSON.stringify(value));
                this.$router.push('/cashManagement/account')
            },
        }
    }
</script>