        ...
        <div>
            ...
            <el-form ref="formData" :model="formData" :rules="formRules" label-width="35%">
                <el-form-item label="转入账簿：" prop="number">
                    <el-select v-model="formData.number" :disabled='true' placeholder="请选择">
                ...
                <el-form-item label="调账原因：">
                    <el-input v-model="formData.name" :disabled='true' placeholder="请输入"></el-input>
                </el-form-item>
            </el-form>
        </div>
        <el-row class="tc mt10">
            <el-button type="primary" @click='getBack'>上一步</el-button>
