<template>
    <div class="one-stop-transfer">
        <el-form ref="formData" :model="formData" :rules="formRules" label-width="35%">
            ...
            <el-form-item label="活期账号：" prop="transOutAcct">
            ...
            <el-form-item label="用途：">
                <el-input v-model="formData.useFor"></el-input>
            </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            next(){
                ...
                // sessionStorage.setItem('taxerTransferPord', JSON.stringify(value));
                this.$router.push('/cashManagement/virPoolPord')
            },
            transReset() {
