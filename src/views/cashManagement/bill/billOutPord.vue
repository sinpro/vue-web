    ...
    <div class="one-stop-transfer">
        <div>
            ...
            <table class='ml40' style='width:96%' cellspacing="0" border="1">
                    <tr class="h40 ">
                        <td class="wr20 pl10">票据类型：</td>
                        <td class="wr30 pl10">{{}}</td>
                        <td class="wr20 pl10">能否转让</td>
                        <td class="wr30 pl10">{{}}</td>
                    </tr>
                    <tr class="h40 ">
                        <td class="pl10">出票日：</td>
                        <td class="pl10">{{}}</td>
                        <td class="pl10">到期日：</td>
                        <td class="pl10">{{}}</td>
                    </tr>
                    <tr class="h40 ">
                        <td class="pl10">出票金额：</td>
                        <td class="pl10">{{}}</td>
                        <td class="pl10">大写金额：</td>
                        <td class="pl10">{{}}</td>
                    </tr>
                    <tr class="h40 ">
                        <td class="pl10">收款人账号：</td>
                        <td class="pl10">{{}}</td>
                        <td class="pl10">收款人名称：</td>
                        <td class="pl10">{{}}</td>
                    </tr>
                    <tr class="h40 ">
                        <td class="pl10">收款人开户行名称：</td>
                        <td class="pl10">{{}}</td>
                        <td class="pl10">收款人开户行行号：</td>
                        <td class="pl10">{{}}</td>
                    </tr>
                    <tr class="h40 ">
                        <td class="pl10">承兑人名称：</td>
                        <td class="pl10">{{}}</td>
                        <td class="pl10">承兑人开户行行号：</td>
                        <td class="pl10">{{}}</td>
                    </tr>
                    <tr class="h40 ">
                        <td class="pl10">释放额度：</td>
                        <td class="pl10">{{}}</td>
                        <td class="pl10">交易合同：</td>
                        <td class="pl10">{{}}</td>
                    </tr>
                    <tr class="h40 ">
                        <td class="pl10">用途：</td>
