<template>
    <div class="plr30">
        ...
        <el-row class="borderb mt20">
            <span class='fl ml20'>他行账户信息</span>
            <span class='fr mr20'>总比数：{{aa}}笔</span>
        </el-row>
        <el-table border class="mtb20" :data="otherTransList">
            <el-table-column min-width='120px' prop="他行账号" label="他行账号"></el-table-column>
            ...
            <el-table-column min-width='120px' prop="账面余额" label="账面余额"></el-table-column>
            <el-table-column min-width='120px' prop="可用余额" label="可用余额"></el-table-column>
            <el-table-column min-width='120px' prop="上次查询时间" label="上次查询时间"></el-table-column>
            <el-table-column prop="postscript" label="操作" >
                <template slot-scope="scope">
                    <button @click="getNew(scope)">刷新</button>
                </template>
            </el-table-column>
        </el-table>
        <el-pagination
