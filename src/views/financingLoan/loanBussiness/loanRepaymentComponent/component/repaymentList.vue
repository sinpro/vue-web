        ...
        <div class="BoxShadow p25 mt20" v-for="(item,index) in 2" :key="index" >
            <div class="flexsb" style="align-items: center;">
               <div class="flex" style="align-items: center;">
                    ...
                    <el-tag v-if="show==1" class="ml20" effect="plain">正常</el-tag>
                  
                    <el-tag v-else type="danger" class="ml20" effect="plain">逾期</el-tag>
                    
                    <span class="ml20 gray2">合同号：8899990000999990</span>
               </div>
               <div>
                   <span v-if="show==1" class="cg ml50 " @click="repayment">还款</span>
                   <span v-else class="cg ml50 " @click="repayment">还逾期</span>
               </div>
            </div>
