...
export default {
  ...
  methods: {
    ...
    goInfo(row) {
      window.sessionStorage.setItem("queryForeignPaymentInfo", row.id);
      this.$router.push({
        path:
          "/groupBusiness/informationQuery/transferTransactions/queryForeignPayment/queryForeignPaymentInfo",
      });
    },
  },
};
