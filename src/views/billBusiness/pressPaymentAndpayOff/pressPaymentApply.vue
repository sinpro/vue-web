<template>
  <div class="pressPaymentApply">
    <div v-if="step == 1">
      <title-bar title="追索申请"></title-bar>
      <el-form
        ref="formData"
        label-width="120px"
        :inline="true"
      ...
      >
        ...
        <el-form-item label="追索类型:" prop="keyWord">
          <el-radio-group v-model="formData.radio">
            <el-radio label="非银行">非拒付追索</el-radio>
            <el-radio label="银行">拒付追索</el-radio>
          </el-radio-group>
        </el-form-item>
      </el-form>
    ...
    <div v-if="step == 2">
      <pressPaymentApplyStep></pressPaymentApplyStep>
    </div>
  </div>
</template>
<script>
...
import pressPaymentApplyStep from "./pressPaymentApplyStep.vue";

export default {
  components: {
    auditProcess,
    pressPaymentApplyStep,
  },
  data() {
