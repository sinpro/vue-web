<template>
  <div class="one-stop-transfer" id="oneStopTransfer">
    ...
    >
      ...
      <title-bar title="承兑人信息"></title-bar>
      <el-form-item label="承兑人名称:" prop="outlets">
        <el-input
      ...
      <el-form-item label="承兑人开户行行号:" prop="outlets">
        <el-input
          v-model="formData.outlets"
          placeholder="请输入"
          disabled
    ...
    <el-row class="tc mtb56">
      ...
      <el-button type="primary" size="medium" @click="transConfirm"
        >下一步</el-button
      >
    </el-row>
