<template>
  <div class="operatorLimit">
    <el-table :data="tableData" stripe class="mt36">
      <el-table-column prop="time" label="操作员编号" width="130" show-overflow-tooltip></el-table-column>
      <el-table-column prop="type" label="操作员姓名" width="130" show-overflow-tooltip></el-table-column>
