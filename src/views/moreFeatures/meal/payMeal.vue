    ...
    <div class="">
        <div v-show="steps=='1'">
            <div>
                <el-form ref="formData" :model="formData" :rules="formRules" label-width="150px">
                    <el-row :gutter="24">
                        ...
                        <el-col :span="9">
                            <el-form-item label="使用渠道：" prop="number">
                        ...
                        <el-col :span="11">
                            <el-form-item label="套餐名称：" prop=" 分配状态">
            ...
            <el-table :border='true' class="mtb20" :data="otherTransList">
                <el-table-column width='100px' prop="购买渠道" label="购买渠道"></el-table-column>
                <el-table-column width='112px' prop="使用渠道" label="使用渠道"></el-table-column>
                <el-table-column width='112px' prop="套餐名称" label="套餐名称"></el-table-column>
                <el-table-column width='140px' prop="套餐笔数(笔)" label="套餐笔数(笔)"></el-table-column>
                <el-table-column width='145px' prop="套餐收费标准" label="套餐收费标准"></el-table-column>
                <el-table-column width='140px' prop="剩余笔数(笔)" label="剩余笔数(笔)"></el-table-column>
                <el-table-column width='140px' prop="扣费日期" label="扣费日期"></el-table-column>
                <el-table-column width='140px' prop="套餐周期" label="套餐周期"></el-table-column>
                <el-table-column width='140px' prop="套餐截止日" label="套餐截止日"></el-table-column>
        ...
        <div v-show="steps=='2'">
            <el-form ref="formData" :model="formData" label-width="35%" class="formW_800">
                ...
                <el-form-item class="mt10" label="套餐剩余笔数：">
                    {{formData.num}}笔
                </el-form-item>
                ...
                <el-form-item class="mt10" label="套餐周期：">
                    {{formData.num}}笔
                </el-form-item>
            ...
            <el-tabs v-model="activeName">
                <el-tab-pane label="扣费记录" name="first">
                    <el-table :border='true' class="mtb20" :data="otherTransList">
            ...
            <el-row class="tc mtb30">
                ...
                <el-button type="primary" v-show='paystate=="未取消续费"' @click="submit">取消续费</el-button>
            </el-row>
        </div>
    </div>
</template>
