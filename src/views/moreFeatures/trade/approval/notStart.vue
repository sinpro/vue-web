        ...
        <div v-show="steps==1">
            ...
            <div class='mt20'>
                <el-card class='mt20' v-for='(item,index) in depositList' :key='index'>
                    ...
                    <div class='tar'>
                      <el-button size='small' @click='goDetail(index,item)'>去审批</el-button>
                    </div>
...
export default {
    ...
    methods: {
        ...
        goDetail(index,item){
            console.log(index)
            console.log(item)
            window.sessionStorage.setItem('waitvalue', JSON.stringify(item));
            this.$router.push('/more/trade/approval/waitForMe/notStart/notStartDet')
        },
