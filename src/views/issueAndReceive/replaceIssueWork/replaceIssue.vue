  ...
  <div class="onTheDial">
    ...
    <div class="infoFill" v-if="steps == 'infoFill'">
      <el-form
        ...
        :model="formData"
      >
        <el-form-item label="工资单文件::" prop="useFor">
          <el-upload
            class="upload-demo"
        ...
        <el-form-item label="实发工资总额:" prop="useFor">
          <el-input
        ...
        <el-form-item label="工资单样式预览:" prop="useFor"> </el-form-item>
      </el-form>
      <div class="tac mtb56">
      ...
      <div class="wPro">
        <p>温馨提示</p>
        <p>
          1.电子工资单仅用于工资单信息发布，请确保发布内容无误，四川农信将不对发布内容的真实性、准确性负责；
        </p>
        <p>2.发布成功后，员工可通过四川农信蜀信e手机银行查询本人的工资单；</p>
        <p>3.企业可根据工资文件模板自定义电子工资单明细字；</p>
        <p>4.员工工资账号仅支持四川农信个人银行账号。</p>
        <p>5.如勾选“隐藏明细”选项，除提交人外，其他用户均无法看到代发明细。</p>
      </div>
    </div>
    <div class="infoConfirm" v-if="steps == 'infoConfirm'">
      ...
      <div class="cen-form flex alc wrap">
        <div class="item">
          <span class="label cp2">实发工资总额</span
          ><span class="value">最多八个最多八个</span>
        </div>
        <div class="item">
          <span class="label cp2">工资单文件</span
          ><span class="value"
            >最多十个最多十个最多
        ...
        <div class="item">
          <span class="label cp2">发放年月</span
          ><span class="value">最多十个最多十个最多</span>
        </div>
        <div class="item">
    ...
    <div class="success" v-if="steps == 'success'">
      <span>实发工资总金额： </span>
      <span class="moneybold">10000000元</span>
      <span class="gray2">(大写：壹贰叁肆)</span>
      <span class="ml36">发放年月：</span>
      <span class="moneybold">10000000元</span>
