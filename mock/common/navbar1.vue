export default [
  ...
  {id:'2',name:'账户管理',path:'',children:[
    {id:'21',name:'财富总览',path:'/accountManagement/assetOverview',children:[
      {id:'211',name:'财富总览211',path:'/accountManagement/assetOverview',children:[
        {id:'2111',name:'财富总览2111',path:'/accountManagement/assetOverview',children:[
          {id:'21111',name:'财富总览21111',path:'/accountManagement/assetOverview',children:[]},
          {id:'21112',name:'财富总览21112',path:'/accountManagement/assetOverview',children:[]},
          {id:'21113',name:'财富总览21113',path:'/accountManagement/assetOverview',children:[]},
        ]},
        {id:'212',name:'财富总览212',path:'/accountManagement/assetOverview',children:[]},
      ]},
      {id:'212',name:'财富总览22',path:'/accountManagement/assetOverview',children:[]},
    ]},
  ...
  {id:'12',name:'更多功能',path:'',children:[
    ...
    {id:'y6',name:'银企直联',path:'',children:[
      {id:'x61',name:'下载中心',path:'',children:[
        {id:'x611',name:'下载中心1',path:'',children:[
          {id:'x611',name:'下载中心11',path:'',children:[
            {id:'x6111',name:'下载中心111',path:'',children:[]},
            {id:'x6112',name:'下载中心112',path:'',children:[]},
            {id:'x6113',name:'下载中心113',path:'',children:[]}
          ]}
        ]}
      ]},
