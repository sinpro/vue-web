export default [
  ...
  {id:'10',name:'特色服务',path:'',children:[
    { id: 'x1', name: '电力缴费', path:'/characteristicService/electricityPayment',children:[]},
    { id: 'x2', name: '财税库银', path:'/characteristicService/fiscalLevy',children:[]},
    { id: 'x3', name: '非税缴费', path:'/characteristicService/nontaxPay',children:[]},
    {id:'x4',name:'预售房资金管理',path:'',children:[
      { id: 'x41', name: '缴款确认', path:'/characteristicService/payConfirm',children:[]},
      { id: 'x42', name: '划拨退款', path:'/characteristicService/transRefund',children:[]},
    ]},
    {id:'x5',name:'投招标保证金',path:'',children:[
      { id: 'x51', name: '非订单模式支付', path:'/characteristicService/noOrderPayment',children:[]},
      { id: 'x52', name: '订单模式支付', path:'/characteristicService/orderPayment',children:[]},
      { id: 'x53', name: '保证金退款', path:'/characteristicService/depositReFund',children:[]},
      { id: 'x54', name: '退款失败清单', path:'/characteristicService/reFundFail',children:[]},
    ]},
    { id: 'x6', name: '缴费记录', path:'/characteristicService/paymentRecords',children:[]},
  ]},
